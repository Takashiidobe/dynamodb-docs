...
| --- | --- | 
| ProductCatalog |  Simple primary key: [\[See the AWS documentation website for more details\]](./AppendixSampleTables.html)  | 
| Forum |  Simple primary key: [\[See the AWS documentation website for more details\]](./AppendixSampleTables.html)  | 
| Thread |  Composite primary key: [\[See the AWS documentation website for more details\]](./AppendixSampleTables.html)  | 
| Reply |  Composite primary key: [\[See the AWS documentation website for more details\]](./AppendixSampleTables.html) | 
...
| --- | --- | 
| PostedBy\-Message\-Index |  Composite primary key: [\[See the AWS documentation website for more details\]](./AppendixSampleTables.html)  | 
