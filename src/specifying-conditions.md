...
![\[Image NOT FOUND\]](./images/info-hiding-horizontal.png)![\[Image NOT FOUND\]](./)![\[Image NOT FOUND\]](./)
...
![\[Image NOT FOUND\]](./images/info-hiding-vertical.png)![\[Image NOT FOUND\]](./)![\[Image NOT FOUND\]](./)
...
| dynamodb:Select |  Represents the `Select` parameter of a `Query` or `Scan` request\. `Select` can be any of the following values: [\[See the AWS documentation website for more details\]](./specifying-conditions.html)  | 
...
| dynamodb:ReturnValues |  Represents the `ReturnValues` parameter of a request\. `ReturnValues` can be any of the following values:  [\[See the AWS documentation website for more details\]](./specifying-conditions.html)  | 
| dynamodb:ReturnConsumedCapacity |  Represents the `ReturnConsumedCapacity` parameter of a request\. `ReturnConsumedCapacity` can be one of the following values: [\[See the AWS documentation website for more details\]](./specifying-conditions.html)  | 
